...
В данном проекте уже подключены все необходимые для работы библиотеки. Он объединяет в одном приложении как серверную, так и клиентскую стороны. Это сделано исключительно для простоты разработки и проверки работы. Проект оснащён встроенными тестами для проверки правильности создания базы данных, эндпоинтов серверного API и клиентских функций доступа к ним.
